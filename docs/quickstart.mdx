...
Easypanel is a modern server control panel for self-hosting applications with Docker.

<Steps>
  <Step title="Access Your Easypanel Instance">
    Log in to your Easypanel dashboard.
  </Step>
  <Step title="Create New Project">
    Create a new project named "bytebot".
  </Step>
  <Step title="Deploy from Docker Compose">
    Use the Docker Compose file from the Bytebot repository to deploy all services.
  </Step>
  <Step title="Configure API Keys">
    Set your AI provider API key (Anthropic, OpenAI, or Gemini) in the environment variables.
  </Step>
  <Step title="Launch">
    Deploy and access your Bytebot instance through the configured domain.
  </Step>
</Steps>

<Note>
  See the full <a href="/deployment/easypanel">Easypanel deployment guide</a> for detailed instructions.
</Note>
